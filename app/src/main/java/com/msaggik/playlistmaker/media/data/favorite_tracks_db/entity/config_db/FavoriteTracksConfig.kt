package com.msaggik.playlistmaker.media.data.favorite_tracks_db.entity.config_db

object FavoriteTracksConfig {
    const val DATABASE_NAME: String = "playlist_maker.db"

    const val FAVORITE_TRACKS_TABLE: String = "favorite_tracks_table"
