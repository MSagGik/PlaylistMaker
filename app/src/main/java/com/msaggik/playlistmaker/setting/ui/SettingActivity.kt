...
class SettingActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        settingsViewModel.getSettingsTheme().value?.let { themeSwitch.setChecked(it) }
//        settingsViewModel.getSettingsTheme().observe(this) {checked -> themeSwitch.setChecked(checked)}
