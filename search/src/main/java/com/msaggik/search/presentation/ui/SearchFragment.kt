package com.msaggik.search.presentation.ui
...
import com.msaggik.search.presentation.ui.adapter.TrackListAdapter
...
import com.msaggik.search.R
import com.msaggik.search.databinding.FragmentSearchBinding
...
class SearchFragment : Fragment() {
    ...
    private fun trackSelection(track: Track) {
        ...
        findNavController().navigate(
            com.msaggik.common_ui.R.id.action_searchFragment_to_playerFragment,
    ...
    private fun mapSearchToPlayer(track: Track): com.msaggik.player.domain.model.Track {
        return with(track) {
