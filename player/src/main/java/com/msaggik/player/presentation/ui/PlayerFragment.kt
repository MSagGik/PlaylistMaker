package com.msaggik.player.presentation.ui
...
import com.msaggik.player.R
import com.msaggik.player.databinding.FragmentPlayerBinding
...
class PlayerFragment : Fragment() {
    ...
    private fun showTrackCover(artworkUrl: String) {
        Glide.with(binding.cover)
            ...
            .placeholder(com.msaggik.common_ui.R.drawable.ic_placeholder)
